...
auto_setup(__file__)
# 本用例测试目标：验证首页显示全部商品模块,向上滑动模块直到页面出现见底文案
...
touch(Template(r"tpl1616067736387.png", record_pos=(0.431, -0.76), resolution=(1080, 1920)))
touch(Template(r"tpl1616067746781.png", record_pos=(0.146, -0.612), resolution=(1080, 1920)))
assert_exists(Template(r"tpl1616067759874.png", record_pos=(-0.39, 0.683), resolution=(1080, 1920)), "点击home回到app首页")
