...
touch(Template(r"tpl1616064981429.png", record_pos=(-0.319, -0.214), resolution=(1080, 1920)))
wait(Template(r"tpl1616064994549.png", record_pos=(-0.234, -0.055), resolution=(1080, 1920)))
assert_exists(Template(r"tpl1616065006921.png", record_pos=(-0.232, -0.048), resolution=(1080, 1920)), "验证分类落地页存在商品")
