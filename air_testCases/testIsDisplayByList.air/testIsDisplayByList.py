...
touch(Template(r"tpl1616040756677.png", record_pos=(0.257, -0.39), resolution=(1080, 1920)))
assert_exists(Template(r"tpl1616040776470.png", record_pos=(0.257, -0.39), resolution=(1080, 1920)))
