...
assert_exists(Template(r"tpl1616061472888.png", record_pos=(0.01, -0.15), resolution=(1080, 1920)))
assert_exists(Template(r"tpl1616061485875.png", record_pos=(-0.016, -0.106), resolution=(1080, 1920)))
