...
touch(Template(r"tpl1616067904448.png", record_pos=(0.149, -0.481), resolution=(1080, 1920)))
assert_exists(Template(r"tpl1616067918970.png", record_pos=(-0.35, 0.319), resolution=(1080, 1920)), "出现twitter图标")
