...
touch(Template(r"tpl1616476760632.png", record_pos=(-0.396, -0.188), resolution=(750, 1334)))
...
for i in range(3):
    swipe((600, 1200),(600, 200))
assert_exists(Template(r"tpl1616398970586.png", record_pos=(-0.004, 0.627), resolution=(750, 1334)), "滑到底部出现提示文案")
